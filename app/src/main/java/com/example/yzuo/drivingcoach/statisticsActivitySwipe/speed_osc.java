 ...
 */
public class speed_osc extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final ViewGroup root = (ViewGroup) inflater.inflate(R.layout.speed_osc, null);
        ...
        if(_option.equals("1")) {
            final commHandler.onResponseListener getStopFactorLastWeekListener = new commHandler.onResponseListener<String>() {
                ...
                public void onResponse(String s) {
                    ...
                    graph.setTitle("Speed oscilations per driven meter");
            ...
            mHandler.get_factor_last_week_history("speed_osc", getStopFactorLastWeekListener);
        }
        //Last month
            ...
            mHandler.get_factor_last_month_history("speed_osc", getStopFactorLastMonthListener);
        }
        //Custom time interval
            ...
            mHandler.get_factor_time_interval_history("speed_osc", _fromDateTime, _toDateTime, getStopFactorTimeIntervalListener);
        }
