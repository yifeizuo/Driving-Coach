...
public class fuel extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final ViewGroup root = (ViewGroup) inflater.inflate(R.layout.fuel, null);
        ...
        if(_option.equals("1")) {
            ...
            mHandler.get_factor_last_week_history("fuel", getStopFactorLastWeekListener);
        }
        //Last month
            ...
            mHandler.get_factor_last_month_history("fuel", getStopFactorLastMonthListener);
        }
        //Custom time interval
            ...
            mHandler.get_factor_time_interval_history("fuel", _fromDateTime, _toDateTime, getStopFactorTimeIntervalListener);
        }
