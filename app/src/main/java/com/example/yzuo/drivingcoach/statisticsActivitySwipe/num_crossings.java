 ...
 */
public class num_crossings extends Fragment {
    ...
    public static Fragment newInstance(Context context, String option, String fromDateTime, String toDateTime) {
        ...
        num_crossings f = new num_crossings();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final ViewGroup root = (ViewGroup) inflater.inflate(R.layout.num_crossings, null);
        ...
        if(_option.equals("1")) {
            final commHandler.onResponseListener getStopFactorLastWeekListener = new commHandler.onResponseListener<String>() {
                ...
                public void onResponse(String s) {
                    ...
                    graph.setTitle("Number of crossings per meter");
            ...
            mHandler.get_factor_last_week_history("num_crossings", getStopFactorLastWeekListener);
        }
        //Last month
            ...
            mHandler.get_factor_last_month_history("num_crossings", getStopFactorLastMonthListener);
        }
        //Custom time interval
            ...
            mHandler.get_factor_time_interval_history("num_crossings", _fromDateTime, _toDateTime, getStopFactorTimeIntervalListener);
        }
