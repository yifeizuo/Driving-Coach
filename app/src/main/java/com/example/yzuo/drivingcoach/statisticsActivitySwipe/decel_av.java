 ...
 */
public class decel_av extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final ViewGroup root = (ViewGroup) inflater.inflate(R.layout.decel_av, null);
        ...
        if(_option.equals("1")) {
            final commHandler.onResponseListener getStopFactorLastWeekListener = new commHandler.onResponseListener<String>() {
                ...
                public void onResponse(String s) {
                    ...
                    graph.setTitle("Average deceleration");
            ...
            mHandler.get_factor_last_week_history("decel_av", getStopFactorLastWeekListener);
        }
        //Last month
            ...
            mHandler.get_factor_last_month_history("decel_av", getStopFactorLastMonthListener);
        }
        //Custom time interval
            ...
            mHandler.get_factor_time_interval_history("decel_av", _fromDateTime, _toDateTime, getStopFactorTimeIntervalListener);
        }
