 ...
 */
public class traffic_lights extends Fragment {
    ...
    public static Fragment newInstance(Context context, String option, String fromDateTime, String toDateTime) {
        ...
        traffic_lights f = new traffic_lights();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final ViewGroup root = (ViewGroup) inflater.inflate(R.layout.traffic_lights, null);
        ...
        if(_option.equals("1")) {
            final commHandler.onResponseListener getStopFactorLastWeekListener = new commHandler.onResponseListener<String>() {
                ...
                public void onResponse(String s) {
                    ...
                    graph.setTitle("Number of traffic lights per meter");
            ...
            mHandler.get_factor_last_week_history("traffic_lights", getStopFactorLastWeekListener);
        }
        //Last month
            ...
            mHandler.get_factor_last_month_history("traffic_lights", getStopFactorLastMonthListener);
        }
        //Custom time interval
            ...
            mHandler.get_factor_time_interval_history("traffic_lights", _fromDateTime, _toDateTime, getStopFactorTimeIntervalListener);
        }
