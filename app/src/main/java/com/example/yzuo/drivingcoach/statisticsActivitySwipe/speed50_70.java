 ...
 */
public class speed50_70 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final ViewGroup root = (ViewGroup) inflater.inflate(R.layout.speed50_70, null);
        ...
        if(_option.equals("1")) {
            final commHandler.onResponseListener getStopFactorLastWeekListener = new commHandler.onResponseListener<String>() {
                ...
                public void onResponse(String s) {
                    ...
                    graph.setTitle("% of time with the speed 50-70 km/h");
            ...
            mHandler.get_factor_last_week_history("speed50_70", getStopFactorLastWeekListener);
        }
        //Last month
            ...
            mHandler.get_factor_last_month_history("speed50_70", getStopFactorLastMonthListener);
        }
        //Custom time interval
            ...
            mHandler.get_factor_time_interval_history("speed50_70", _fromDateTime, _toDateTime, getStopFactorTimeIntervalListener);
        }
