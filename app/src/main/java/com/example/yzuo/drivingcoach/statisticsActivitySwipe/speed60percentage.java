 ...
 */
public class speed60percentage extends Fragment {
    ...
    public static Fragment newInstance(Context context, String option, String fromDateTime, String toDateTime) {
        ...
        speed60percentage f = new speed60percentage();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final ViewGroup root = (ViewGroup) inflater.inflate(R.layout.speed60percentage, null);
        ...
        if(_option.equals("1")) {
            final commHandler.onResponseListener getStopFactorLastWeekListener = new commHandler.onResponseListener<String>() {
                ...
                public void onResponse(String s) {
                    ...
                    graph.setTitle("% of trip distance with speed limit 60 km/h");
            ...
            mHandler.get_factor_last_week_history("speed60percentage", getStopFactorLastWeekListener);
        }
        //Last month
            ...
            mHandler.get_factor_last_month_history("speed60percentage", getStopFactorLastMonthListener);
        }
        //Custom time interval
            ...
            mHandler.get_factor_time_interval_history("speed60percentage", _fromDateTime, _toDateTime, getStopFactorTimeIntervalListener);
        }
