...
import static com.example.yzuo.drivingcoach.commHandler.*;

/**
 * Created by Yifei on 8/10/2015.
 */
public class stop_factor extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final ViewGroup root = (ViewGroup) inflater.inflate(R.layout.stop_factor, null);

        final commHandler mHandler = new commHandler(_context);
        //Last week
        if(_option.equals("1")) {
            final onResponseListener getStopFactorLastWeekListener = new commHandler.onResponseListener<String>() {
                ...
                public void onResponse(String s) {
                    ...
                    graph.setTitle("% of time with the speed < 2 km/h");
            ...
            mHandler.get_factor_last_week_history("stop_factor", getStopFactorLastWeekListener);
        }
        //Last month
        else if (_option.equals("2")) {
            final onResponseListener getStopFactorLastMonthListener = new commHandler.onResponseListener<String>() {
                @Override
                public void onResponse(String s) {
                    if (s.equals("")) {
                        Toast.makeText(_context, "No data", Toast.LENGTH_SHORT).show();
            ...
            mHandler.get_factor_last_month_history("stop_factor", getStopFactorLastMonthListener);
        }
        //Custom time interval
        else if (_option.equals("3")) {
            final onResponseListener getStopFactorTimeIntervalListener = new commHandler.onResponseListener<String>() {
                @Override
                public void onResponse(String s) {
                    if (s.equals("")) {
                        Toast.makeText(_context, "No data", Toast.LENGTH_SHORT).show();
            ...
            mHandler.get_factor_time_interval_history("stop_factor", _fromDateTime, _toDateTime, getStopFactorTimeIntervalListener);
        }
